from src.cq_convert.model_adapters.naming import cactus_name_for_tensor
from src.cq_convert.model_adapters.policy import policy_for_tensor
from src.cq_convert.cli import _bits_for_component
from src.cq_convert.model_adapters.detection import detect_family
from src.cq_convert.cactus_adapters.config_utils import extract_parakeet_tdt_config, extract_whisper_config
from src.cq_convert.cli import _augment_state_dict_for_family
from src.cq_convert.model_adapters.adapters import adapter_for_family
import torch
