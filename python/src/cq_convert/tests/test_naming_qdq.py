...
from src.cq_convert.cactus_adapters.tensor_io import save_tensor_with_header
from src.cq_convert.export.qdq import convert_qdq
from src.cq_convert.model_adapters.naming import cactus_name_for_tensor, restore_hf_key_for_family
...
def test_manifest_qdq_restores_int8_depthwise_conv_shape(tmp_path):
    from src.cq_convert.cactus_adapters.tensor_io import save_depthwise_conv_int8_with_header
