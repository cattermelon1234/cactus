...
void compute_masked_scatter_node(GraphNode& node, const std::vector<std::unique_ptr<GraphNode>>& nodes, const std::unordered_map<size_t, size_t>& node_index_map);
...
void compute_conv2d_node(GraphNode& node, const std::vector<std::unique_ptr<GraphNode>>& nodes, const std::unordered_map<size_t, size_t>& node_index_map);
...
public:
    ...
    size_t scalar_floor_divide(size_t input, float value);
    ...
    size_t masked_scatter(size_t input, size_t mask, size_t source);
    ...
    size_t gather(size_t embeddings, size_t indices, int axis = 0);
    ...
    size_t conv2d(size_t input, size_t weight, size_t stride = 1, size_t padding = 0, size_t dilation = 1, size_t groups = 1);
    size_t conv2d(size_t input, size_t weight, size_t bias, size_t stride, size_t padding, size_t dilation, size_t groups);
