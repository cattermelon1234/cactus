...
const Schema& op_schema(OpType op_type) {
    ...
    static const std::unordered_map<OpType, Schema> kSchemas = {
        ...
        {OpType::SCALAR_FLOOR_DIVIDE, {{ParamField::Scalar, FieldPersistence::Persistent}}},
        ...
        {OpType::GATHER, {{ParamField::Axis, FieldPersistence::Persistent}}},
        ...
        {OpType::CONV2D, {
            ...
            {ParamField::Padding, FieldPersistence::Persistent},
            {ParamField::Dilation, FieldPersistence::Persistent},
            {ParamField::NumGroups, FieldPersistence::Persistent},
        }},
...
void write_field(std::ostream& out, ParamField field, const OpParams& params) {
    switch (field) {
        ...
        case ParamField::Padding: write_u64(out, static_cast<uint64_t>(params.padding)); break;
    }
}
...
void read_field(std::istream& in, ParamField field, OpParams& params) {
    switch (field) {
        ...
        case ParamField::Padding: params.padding = static_cast<size_t>(read_u64(in)); break;
    }
}
