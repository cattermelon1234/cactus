...
CACTUS_FFI_EXPORT int cactus_decode_tokens(
    cactus_model_t model,
...
CACTUS_FFI_EXPORT int cactus_graph_masked_select_prefix(cactus_graph_t graph, cactus_node_t input, cactus_node_t mask, cactus_node_t* out);
CACTUS_FFI_EXPORT int cactus_graph_masked_scatter(cactus_graph_t graph, cactus_node_t input, cactus_node_t mask, cactus_node_t source, cactus_node_t* out);
...
CACTUS_FFI_EXPORT int cactus_graph_matmul(
    cactus_graph_t graph, cactus_node_t a, cactus_node_t b, bool pretransposed_rhs, int32_t backend, int32_t output_precision, cactus_node_t* out);
...
CACTUS_FFI_EXPORT int cactus_graph_conv2d_k3s1p1(
    cactus_graph_t graph, cactus_node_t input, cactus_node_t weight, bool has_bias, cactus_node_t bias, cactus_node_t* out);
CACTUS_FFI_EXPORT int cactus_graph_conv2d(
    cactus_graph_t graph, cactus_node_t input, cactus_node_t weight, bool has_bias, cactus_node_t bias,
    size_t stride, size_t padding, size_t dilation, size_t groups, cactus_node_t* out);
