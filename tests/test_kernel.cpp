...
int main() {
    ...
    runner.run_test("Kernel Sum Axis Inner1 Correctness", test_neon_sum_axis_inner1_correctness());
    runner.run_test("Kernel Mean Axis Inner1 Correctness", test_neon_mean_axis_inner1_correctness());
    runner.run_test("Kernel Variance Axis Inner1 Correctness", test_neon_variance_axis_inner1_correctness());
    runner.run_test("Kernel Variance Axis Non-Inner1 Correctness", test_neon_variance_axis_non_inner1_correctness());
    runner.run_test("Kernel Min Axis Inner1 Correctness", test_neon_min_axis_inner1_correctness());
    runner.run_test("Kernel Max Axis Inner1 Correctness", test_neon_max_axis_inner1_correctness());
